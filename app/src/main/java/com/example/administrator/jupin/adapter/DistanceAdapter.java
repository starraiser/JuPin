...
public class DistanceAdapter extends BaseAdapter{
    ...
    private DistanceScreenCallback callback;
    ...
    public DistanceAdapter(Context context, List<String> list,DistanceScreenCallback callback) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.mText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                callback.onDistanceClick(viewHolder.mText.getText().toString());
    ...
    public interface DistanceScreenCallback{
